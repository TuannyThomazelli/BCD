...
SELECT tb_aluno.nome, tb_curso.nome_curso FROM tb_aluno INNER JOIN tb_curso
ON tb_aluno.CURSOS_id_curso = tb_curso.id_curso;

SELECT * FROM tb_aluno LEFT JOIN tb_curso ON tb_aluno.CURSOS_id_curso = tb_curso.id_curso;

SELECT * FROM tb_aluno RIGHT JOIN tb_curso ON tb_aluno.CURSOS_id_curso = tb_curso.id_curso
